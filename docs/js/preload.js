...
// const CDN_URL = 'https://3ad68020-4d43-4164-8772-43d3de9c78fd.akamaized.net'
const CDN_URL = '.'
...
export function preloadAssets() {
    ...
    // Load bitmap font
    this.load.bitmapFont('light', `${CDN_URL}/assets/font/light.png`, `${CDN_URL}/assets/font/light.xml`);
    this.load.bitmapFont('dark', `${CDN_URL}/assets/font/dark.png`, `${CDN_URL}/assets/font/dark.xml`);
    this.load.bitmapFont('stock', `${CDN_URL}/assets/font/stock.png`, `${CDN_URL}/assets/font/stock.xml`);
...
function preloadButtons() {
    ...
    this.load.image('donate', `${CDN_URL}/assets/buttons/donate.png`)
...
function preloadLevel2() {
    ...
    this.load.image('2-quarantine-ready', `${CDN_URL}/assets/level2/market/quarantine-ready.png`)
    // Products
...
function preloadLevel3() {
    ...
    // Stock
    this.load.image('3-stock-apple', `${CDN_URL}/assets/level3/stock/apple.png`)
    this.load.image('3-stock-facebook', `${CDN_URL}/assets/level3/stock/facebook.png`)
    this.load.image('3-stock-amazon', `${CDN_URL}/assets/level3/stock/amazon.png`)
    this.load.image('3-stock-google', `${CDN_URL}/assets/level3/stock/google.png`)
    this.load.image('3-stock-microsoft', `${CDN_URL}/assets/level3/stock/microsoft.png`)
    // Home
    ...
    this.load.image('3-owl-egg', `${CDN_URL}/assets/level3/owl/egg.png`)
    this.load.image('3-toilet', `${CDN_URL}/assets/level3/toilet.png`)
    this.load.spritesheet('3-cat', `${CDN_URL}/assets/level3/cat/idle.png`, {
        frameWidth: 35, frameHeight: 43
    })
    this.load.spritesheet('3-cat-hurt', `${CDN_URL}/assets/level3/cat/hurt.png`, {
        frameWidth: 39, frameHeight: 47
    })
    this.load.spritesheet('3-cat-run', `${CDN_URL}/assets/level3/cat/run.png`, {
